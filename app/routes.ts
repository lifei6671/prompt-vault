...
export default [index("routes/home.tsx"), route("prompt/:slug", "routes/prompt-detail.tsx"),
  ...
  route("admin", "routes/admin.tsx", [index("routes/admin-index.tsx"), route("categories", "routes/admin-categories.tsx"), route("tags", "routes/admin-tags.tsx"), route("prompts", "routes/admin-prompts.tsx"), route("prompts/new", "routes/admin-prompt-new.tsx"), route("prompts/new/image/:kind", "routes/admin-prompt-upload.ts"), route("prompts/:id/edit", "routes/admin-prompt-edit.tsx"), route("prompts/:id/preview", "routes/admin-prompt-preview.tsx")])] satisfies RouteConfig;
