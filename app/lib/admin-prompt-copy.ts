...
const copy = {
  "zh-CN": {
    ...
    variableCount: "变量数", imageState: "图片状态", referenceImageRequired: "需要参考图片",
    requirementYes: "是", requirementNo: "否", importErrors: "需要修正", importWarnings: "提示",
    ...
    create: "新建 Prompt", createDraft: "创建草稿", creatingDraft: "正在创建…", processing: "处理中…", sourceLanguage: "原文语言", chooseLanguage: "选择语言",
    chooseCategory: "选择分类", uploadImage: "上传图片", originalImage: "选择原图（JPEG、PNG、WebP，最大 20 MiB）",
    selectImage: "选择图片", previewEmpty: "尚未选择图片",
  ...
  "en-US": {
    ...
    variableCount: "Variables", imageState: "Image status", referenceImageRequired: "Reference image required",
    requirementYes: "Yes", requirementNo: "No", importErrors: "Fix these", importWarnings: "Notes",
    ...
    create: "New prompt", createDraft: "Create draft", creatingDraft: "Creating…", processing: "Processing…", sourceLanguage: "Source language", chooseLanguage: "Choose language",
    chooseCategory: "Choose category", uploadImage: "Upload image", originalImage: "Choose original (JPEG, PNG, WebP; up to 20 MiB)",
    selectImage: "Choose image", previewEmpty: "No image selected",
